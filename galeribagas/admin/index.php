                    ...
                    <div class="col-md-4">
                      <div class="m-2">
                        <div class="overflow-auto">
                          ...
                          <form action="../config/proses_komentar.php" method="post" style="float: right;">
											          <button type="submit" name="isikomentar" class="btnhapus" value="<?php echo $row['isikomentar']; ?>"><i class="fa-solid fa-trash"></i></button>
											    </form>
                          <?php } ?>
                          <hr>
